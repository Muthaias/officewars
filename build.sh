...
emcc src/lazy-client/*.c src/common/*.c src/common/math/*.c -s WASM=1 -s FETCH=1 -o lazy-client -s EXPORTED_FUNCTIONS='["_loadGames","_getGameCount","_getGame","_getGameName","_getPlayerCount","_getPlayerName","_getPlayerColor","_getNodeCount","_getNodeConnected","_getNodeControlledBy","_getTurnCount","_stepGameHistory"]' -s EXPORTED_RUNTIME_METHODS='["ccall","cwrap"]'
